        ...
        <div id="content-wrapper" class="d-flex flex-column bg-gray-900">
            ...
            @include ('layout.topbar')
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-center mb-4" style="margin-top: 2%">
                        <h1 class="font-weight mb-0 text-gray-100">Dashboard</h1>
