        ...
        <div class="row">
            ...
            <div class="col-6 text-center">
                <div style="margin-bottom:20px">
                    <h1 class="font-weight-bold mb-0 text-gray-100">Frekuensi</h1>
                </div>
                            ...
                            <table class="table table-bordered mb-0">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-gray-100" scope="col">Frekuensi</th>
                                    </tr>
                                </thead>
            ...
            <div class="col-6 px-4" style="margin-top: 65px; color:#EEEEEE; text-align:justify">
                <p style="font-size:24px"> Data tersebut adalah data dari <b style="color:#FFD369">Rata-Rata Nilai
                        Frekuensi</b> yang masuk kedalam sistem tiap jam selama satu hari.
                ...
                <div class="col-sm-4 mb-1 px-0 mb-sm-0" style="margin-top:0px">
                    <a href="{{ route('frequency.export') }}" class="btn btn-user btn-block" style="background:#151A21">
